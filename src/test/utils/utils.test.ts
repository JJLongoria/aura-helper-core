...
describe('Testing ./src/utils/utils.js', () => {
    ...
    test('Testing getCallbackFunction()', () => {
        ...
        expect(Utils.getCallbackFunction(["string"])).toEqual(undefined);
    ...
    test('Testing sort()', () => {
        ...
        expect(Utils.sort(data, ['key', 'field'], true)).toEqual([
            {
                key: 'Value1',
                field: 'value1',
            },
        ...
        expect(Utils.sort([{key: 2}, {key: 1}], ['key'], true)).toEqual([
            {
                key: 1,
            },
            {
        ...
        expect(Utils.sort([{key:1}, {key: 2}], ['key'], true)).toEqual([
            {
                key: 1,
            },
            {
        ...
        expect(Utils.sort([{key: 2}, {key: 2}], ['key'], true)).toEqual([
            {
                key: 2,
            },
            {
