...
function validateMetadataType(metadataType, key) {
    ...
    if (!utils_1.Utils.isString(metadataType.path)) {
    ...
    if (!utils_1.Utils.isString(metadataType.suffix)) {
...
function validateMetadataObject(metadataObject, key, type) {
    ...
    if (!utils_1.Utils.isString(metadataObject.path)) {
...
function validateMetadataItem(metadataItem, key, object, type) {
    ...
    if (!utils_1.Utils.isString(metadataItem.path)) {
