...
const metadataItem_1 = require("./metadataItem");
/**
...
class MetadataObject {
     ...
     */
    constructor(nameOrMetadataObject, checked, path, childs) {
    ...
    addChild(childOrName, child) {
        if (childOrName instanceof metadataItem_1.MetadataItem && !utils_1.Utils.isNull(childOrName.name)) {
    ...
    getChild(name) {
        if (this.childs[name]) {
            return new metadataItem_1.MetadataItem(this.childs[name]);
        }
        return undefined;
    }
    /**
